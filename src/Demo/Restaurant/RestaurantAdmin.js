...
class ResturantAdmin extends React.Component {
	render() {
		const tabContent = (
			<Aux>
			...
			<Aux>
				<Row>
					...
					<Col md={6}>
						<Card>
							<Card.Body>
								<h6 className="mb-4">Total Sales</h6>
								<div className="row d-flex align-items-center">
									<div className="col-9">
										<h3 className="f-w-300 d-flex align-items-center m-b-0">
											<i className="feather icon-arrow-up text-c-green f-30 m-r-5" /> $10.638.32
										</h3>
									</div>

									<div className="col-3">
										<p className="m-b-0">90%</p>
									</div>
								</div>
								<div className="progress m-t-30" style={{ height: '7px' }}>
									<div
									...
									<tbody>
										<tr className="unread">
											...
											<td>
												...
												<a href={DEMO.BLANK_LINK} className="label theme-bg text-white f-12">
													Approve
												</a>
											</td>
										</tr>
